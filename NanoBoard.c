...
// TODO: Replace these structures with an SDI handle to the SD card
...
// TODO: This function apparently is some kind of interrupt that writes the temperatur to the log. I am not deleting it because it's interesting example code, but I don't need it.
...
// TODO: Won't need this; I don't intend to access the filesystem as FAT; only as blocks. The algorithm will be FAT aware, but will not use a FAT library.
...
//{
	...
	//TimeDate_t CurrentTimeDate;'
	// TODO: interesting example code for an RTC
	//RTC_GetTimeDate(&CurrentTimeDate);
